...
import searchSources from "~/data/searchSources.server";
import {
  Form,
  Link,
  Outlet,
...
export const loader: LoaderFunction = (args) => {
  return remixAppLoader(args, searchSources);
};

export default UserSourcesPage;
